...
def convert_to_color_(dataname, arr_2d, palette=None):
    ...
    if palette is None:
        palette = {0: (0, 0, 0)}
        if dataname == 'CongHoa':
            flatui = ["#228b22", "#ff0000", "#ffff00", "#0000ff", "#6495ed",
                "#7fffd4", "#00fa9a", "#191970", "#fafad2", "#000000"] 
        elif dataname == 'DongXing':
            flatui = ["#228b22", "#ff0000", "#ff69b4", "#ffff00", "#0000ff", "#6495ed",
                "#7fffd4", "#00fa9a", "#191970", "#fafad2", "#4682b4", "#1e90ff", "#000000"] 
        else:
...
# 给不同类别的groundtruth染色
def display_goundtruth(dataname, gt, vis, caption=""):
    color_gt = convert_to_color_(dataname, gt)
